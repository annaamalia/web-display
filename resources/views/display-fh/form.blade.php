            ...
            <div class="modal-dialog">
                <div class="modal-content bg-grey">
                    ...
                    <div class="modal-body bg-grey">
                        <form class="{{ route('formfh.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        <div class="btn-group" role="group">
                                            <form action="{{ route('formfh.show', $item->id) }}" method="head">
                                            ...
                                            <form action="{{ route('formfh.destroy', $item->id) }}" method="post">
                                                @csrf
                                                @method('delete')
                                                <input type="hidden" name="id" id="id"
                                                    value="{{ $item->id }}">
