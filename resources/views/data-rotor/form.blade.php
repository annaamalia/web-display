        ...
        <div class="row">
                ...
                <div class="modal-dialog">
                    <div class="modal-content bg-grey">
                        ...
                        <div class="modal-body bg-grey">
                            <form class="{{ route('datarotor.store') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <select name="id_gambar" id="id_gambar" class="form-control" required>
                                        ...
                                        @foreach ($displayrotor as $index => $item)
            ...
            <div class="col-12">
                <div class="d-flex justify-content-between"
                    ...
                    onclick="history.back('display-rotor.index')">Back</button>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <div class="btn-group" role="group">
                                                <form action="{{ route('datarotor.show', $item->id) }}"
                                                    method="head">
                                                ...
                                                <form action="{{ route('datarotor.destroy', $item->id) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('delete')
                                                    <input type="hidden" name="id" id="id"
