                ...
                <div class="modal-dialog">
                    <div class="modal-content bg-grey">
                        ...
                        <div class="modal-body bg-grey">
                            <form class="{{ route('datafh.store') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <select name="id_gambar" id="id_gambar" class="form-control" required>
                                        ...
                                        @foreach ($displayfh as $index => $item)
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <div class="btn-group" role="group">
                                                <form action="{{ route('datafh.show', $item->id) }}"
                                                    method="head">
                                                ...
                                                <form action="{{ route('datafh.destroy', $item->id) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('delete')
                                                    <input type="hidden" name="id" id="id"
